...
public class UpdateEmployeePassword {
    ...
    /*
     *
     * This program updates your existing moviedb employee table to change the
    ...
    public static void main(String[] args) throws Exception {
        ...
        String alterQuery = "ALTER TABLE employee MODIFY COLUMN password VARCHAR(128)";
        ...
        while (rs.next()) {
            ...
            String updateQuery = String.format("UPDATE employee SET password='%s' WHERE id=%s;", encryptedPassword,
                    id);
